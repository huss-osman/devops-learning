...
- [CI/CD Fundamentals](./01-cicd-fundamentals.md)  
...
- Learn how GitHub Actions automates development workflows
- Understand workflow events, jobs, steps, and actions
- Build structured CI/CD pipelines using YAML
- Apply testing and security within automated pipelines
- Understand reusable workflows and custom actions
- Build confidence troubleshooting CI/CD workflows
- Develop a strong foundation for production CI/CD
